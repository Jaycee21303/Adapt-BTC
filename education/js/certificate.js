...
document.addEventListener('DOMContentLoaded', () => {
    ...
    downloadBtn.addEventListener('click', (event) => {
        ...
        const certificateMarkup = `<!DOCTYPE html>
            ...
            <body>
                <div class="certificate">
                    ...
                    <p class="meta" id="certificate-date"></p>
                </div>
            </body>
            </html>`;
        ...
        const nameTarget = certificateWindow.document.getElementById('certificate-name');
        const dateTarget = certificateWindow.document.getElementById('certificate-date');

        if (nameTarget) nameTarget.textContent = learnerName;
        if (dateTarget) dateTarget.textContent = `Date: ${completionDate}`;
